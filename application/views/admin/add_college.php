...
<td width="4">&nbsp;</td>
<td width="390"><textarea required class="form-control input-sm" id="tx32" name="txt3" value="<?php echo set_value("txt3");?>"  rows="3" ></textarea> </td>
<td width="53">&nbsp </td>
<td width="90"><label for="name">District <a style="color:#FF0000;font-size:18px;">*</a></label></td>
<td width="5">&nbsp;</td>
<td width="440"><input required type="text" class="form-control input-sm" id="txt4" name="txt4" value="<?php echo set_value("txt4");?>"></td>
</tr>
