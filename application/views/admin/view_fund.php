...
<?php if($nss_fund_list[0]['verification_id']=="3"){?>
...
<?php } elseif($nss_fund_list[0]['verification_id']=="2R"){ ?>
STATUS : REJECTED BY ASSISTANT, FORWARDED TO SO ---- REMARKS:<?php echo $nss_fund_list[0]['remarks'] ; } }?>
</div>
                    ...
                    <tbody>
					  <?php if(isset($nss_fund_list)){ $i=0;foreach ($nss_fund_list as $value ){ ?>
                        <tr   class="wordbreak">
                          ...
                          <?php } ?>
                          <td>
                          <?php if($value['verification_id']=="2") echo "FORWARD TO ASSIATANT"; elseif($value['verification_id']=="2R") echo "REJECTED BY ASSISTANT";elseif($value['verification_id']=="3") echo "FORWARDED TO SO";  elseif($value['verification_id']=="3R") echo "REJECTED BY SO"; elseif($value['verification_id']=="4") echo "ACCEPETD BY UNIVERSITY";?>
                          </td>
...
<?php if( isset($nss_fund_list) && !empty($nss_fund_list) && $nss_fund_list[0]['verification_id']=="2"){ ?>
<div class="w3-center">		
