...
<br />
<span style="color:#800000; padding-left:15px;">
NOTE:<br />
If more than one unit exist in the college (Eg: unit 73, Principal can create unit as UNIT-73 A and UNIT-73 B respectively).<br />
Assign PO's to the corresponing UNIT, then only PO's are allowed to login.
<br /><br />
</span>
...
<table width="100%" height="100%" cellpadding="0" cellspacing="0">
  <tr>
              ...
              <label for="mobile">UNIT ID:<a style="color:#FF0000;font-size:18px;">*</a></label>
          </div></td>
          <td width="10%"><div class="form-group ">
            <input type="text" class="form-control input-sm" id="unit" size="10"  name="unit" autocomplete="off"   value="<?php echo set_value("unit");?>" />
          </div></td>
          ...
          <td width="5%"><div class="form-group "><input type="text" class="form-control input-sm " id="fromdate"  size="10" name="fromdate" value="<?php echo set_value("fromdate");?>"  maxlength="10" autocomplete="off" onkeypress="return input_date(event)" /></div></td>
		  <td width="1%"></td>
          <td width="8%"><div class="form-group ">
              <label for="name">To date <a style="color:#FF0000;font-size:18px;">*</a> </label>
          </div></td>
          <td width="11%"><div class="form-group "><input type="text" class="form-control input-sm datepicker" id="todate" name="todate"  size="10" value="<?php echo set_value("todate");?>"  maxlength="10" autocomplete="off" onkeypress="return input_date(event)"></div></td>
          <td width="2%"></td>
		  <td width="6%"><div class="form-group ">
		  ...
		  <td width="8%"></td>
          <td width="1%" align="left"><div class="form-group ">
        ...
        <tr>
        <td colspan="3"><span style="color:#F00;"><?php echo form_error('unit'); ?></span></td>         
          <td>&nbsp;</td>
