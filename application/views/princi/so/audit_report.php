...
<form name="frm1" id="frm1" method="post"   action="<?php echo base_url(); ?>Admin/NssSo/audit_report" enctype="multipart/form-data"  >
...
<td><?php
if($value['verification_id']=="3") echo"Forwarded to SO"; elseif($value['verification_id']=="3R") echo "Rejected by SO"; elseif($value['verification_id']=="4") echo "Accepted by SO";
?></td>
...
<?php if (isset($audit_det)&&!empty($audit_det)&& $audit_det[0]['verification_id']== "3"){ ?>
