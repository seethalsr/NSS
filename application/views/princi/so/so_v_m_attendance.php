...
<?php if(isset($month_view_data_uni)&&!empty($month_view_data_uni)){ ?>
...
<legend class="scheduler-border"><span style=" font-size:18px; color:#000080; font-weight:bold;">Status: Forwarded to SO</span></legend>
 <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  <?php $value = ""; $i=0; foreach ($month_view_data_uni as $valueb ){ $i++; ?>
                        <tr   class="wordbreak">
                          <td><?php echo $i; ?></td>
					...
					<input type="submit" value="ACCEPTED" id="fwd_uni" name="fwd_uni" class="btn" style="background:#09C; color:#FFF;"  />
