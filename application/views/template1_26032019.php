...
<link href="<?php echo base_url();?>images/kulogo.png" rel="shortcut icon" type="image/x-icon" />
...
<tr>
<td width="3%">&nbsp;</td>
<td width="18%" height="100"><img src="<?php echo base_url();?>images/kulogo.png"  alt="" width="8"  style="width:120px; height:70px; padding-right:5px;" /><br />
  <br /></td>
<td width="79%">
...
<!--login-->
       ...
       <?php if(isset($captcha)) {?>
		  ...
		  <p style="border:1px solid blue;"></p>
    		...
    		<span class="psw"><a  onclick="document.getElementById('id01').style.display='block'" name="fopwd" id="fopwd">Forgot password?</a> 
          </span>
...
<footer  class="w3-container   w3-padding-32 " style="background-color:#333">
   ...
   <tr><td width="271">
   <a href="https://www.google.co.in/maps/place/Mahatma+Gandhi+University+(MGU)/@9.6579672,76.5305753,17z/data=!3m1!4b1!4m5!3m4!1s0x3b07d4966ae341b3:0x28c5386352d8cbb9!8m2!3d9.6579672!4d76.532764"
    target="_blank">
	...
	Priyadarsini Hills<br />
	Kottayam, kerela,India<br />
	Pin:686560</p>
	</td>
	...
	Talk About Us @
	<br />
	<a href="https://www.fb.com" class="fa fa-facebook"></a>
...
<p> Know More About Us At: <a href="https://www.mgu.ac.in/" style="color:#FFF" target="_blank">mgu.ac.in</a> </p>
...
<footer class="w3-container  w3-padding-16" style="background-color:#333; border:0;border-top:1px solid #CCC;border-top-width:1px; margin-top:20px ">
   ...
   <p align="center" style="font-size:12px ;color:#FFF">&copy; <?php echo date("Y");?> Mahatma Gandhi University. All Rights Reserved by CITAD, <br /> Mahatma Gandhi University, Kottayam, Kerala </p>
</footer>
