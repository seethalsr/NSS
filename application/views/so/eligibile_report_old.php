...
<?php if( isset($eli_det) && !empty($eli_det) && $eli_det[0]['verification_id']=="3"){ ?>
<div class="w3-center">		
<input type="submit" class="btn btn-primary" value="ACCEPTED BY SO" name="fwdassi" id="fwdassi" style="background-color:#0080C0; color:#FFF"/>
