...
<?php if($camp_detail[0]['verification_id']=="3R"){ ?>
...
<?php } ?>
  ...
  <?php if(isset($camp_detail[0]['verification_id'])&& $camp_detail[0]['verification_id']=="3" ) { ?>
 <input type="submit" value="ACCEPTED" id="fwdtoassi" name="fwdtoassi" class="w3-button  w3-green "  />  
