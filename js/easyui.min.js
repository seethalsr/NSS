...
var _8e8=_8e5.originalRows;
var _8e9=_8e5.updatedRows;
var _8ea=_8e5.insertedRows;
var _8eb=_8e5.deletedRows;
$(_8e3).datagrid("loadData",[row]);
_8e5.originalRows=$.extend([],_8e8);
_8e5.updatedRows=$.extend([],_8e9);
_8e5.insertedRows=$.extend([],_8ea);
_8e5.deletedRows=$.extend([],_8eb);
_8e5.insertedRows.push(row);
return;
}
...
var _8ef=_8ee?1:2;
var _8f0=opts.finder.getTr(_8e3,_8ed-1,"body",_8ef);
var tr=opts.finder.getTr(_8e3,_8ed,"body",_8ef);
tr.insertAfter(_8f0);
};
},updateRow:function(_8f1,_8f2,row){
var opts=$.data(_8f1,"datagrid").options;
$.fn.datagrid.defaults.view.updateRow.call(this,_8f1,_8f2,row);
var tb=opts.finder.getTr(_8f1,_8f2,"body",2).closest("table.datagrid-btable");
var _8f3=parseInt(tb.prev().attr("group-index"));
this.refreshGroupTitle(_8f1,_8f3);
},deleteRow:function(_8f4,_8f5){
var _8f6=$.data(_8f4,"datagrid");
var opts=_8f6.options;
var dc=_8f6.dc;
var body=dc.body1.add(dc.body2);
var tb=opts.finder.getTr(_8f4,_8f5,"body",2).closest("table.datagrid-btable");
var _8f7=parseInt(tb.prev().attr("group-index"));
$.fn.datagrid.defaults.view.deleteRow.call(this,_8f4,_8f5);
var _8f8=this.groups[_8f7];
if(_8f8.rows.length>1){
_8f8.rows.splice(_8f5-_8f8.startIndex,1);
this.refreshGroupTitle(_8f4,_8f7);
}else{
body.children("div.datagrid-group[group-index="+_8f7+"]").remove();
for(var i=_8f7+1;i<this.groups.length;i++){
body.children("div.datagrid-group[group-index="+i+"]").attr("group-index",i-1);
}
this.groups.splice(_8f7,1);
}
var _8f5=0;
for(var i=0;i<this.groups.length;i++){
var _8f8=this.groups[i];
_8f8.startIndex=_8f5;
_8f5+=_8f8.rows.length;
}
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{groupHeight:21,expanderWidth:16,singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_8b8,groupField:"group",groupFormatter:function(_8f9,rows){
return _8f9;
}});
})(jQuery);
(function($){
function _8fa(_8fb){
var _8fc=$.data(_8fb,"treegrid");
var opts=_8fc.options;
$(_8fb).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
return false;
},onLoadSuccess:function(){
},onResizeColumn:function(_8fd,_8fe){
_90b(_8fb);
opts.onResizeColumn.call(_8fb,_8fd,_8fe);
},onBeforeSortColumn:function(sort,_8ff){
if(opts.onBeforeSortColumn.call(_8fb,sort,_8ff)==false){
return false;
}
},onSortColumn:function(sort,_900){
opts.sortName=sort;
opts.sortOrder=_900;
if(opts.remoteSort){
_90a(_8fb);
}else{
var data=$(_8fb).treegrid("getData");
_939(_8fb,null,data);
}
opts.onSortColumn.call(_8fb,sort,_900);
},onClickCell:function(_901,_902){
opts.onClickCell.call(_8fb,_902,find(_8fb,_901));
},onDblClickCell:function(_903,_904){
opts.onDblClickCell.call(_8fb,_904,find(_8fb,_903));
},onRowContextMenu:function(e,_905){
opts.onContextMenu.call(_8fb,e,find(_8fb,_905));
}}));
var _906=$.data(_8fb,"datagrid").options;
opts.columns=_906.columns;
opts.frozenColumns=_906.frozenColumns;
_8fc.dc=$.data(_8fb,"datagrid").dc;
if(opts.pagination){
var _907=$(_8fb).datagrid("getPager");
_907.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_908,_909){
opts.pageNumber=_908;
opts.pageSize=_909;
_90a(_8fb);
}});
opts.pageSize=_907.pagination("options").pageSize;
}
};
function _90b(_90c,_90d){
var opts=$.data(_90c,"datagrid").options;
var dc=$.data(_90c,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight)){
if(_90d!=undefined){
var _90e=_90f(_90c,_90d);
for(var i=0;i<_90e.length;i++){
_910(_90e[i][opts.idField]);
}
}
}
$(_90c).datagrid("fixRowHeight",_90d);
function _910(_911){
var tr1=opts.finder.getTr(_90c,_911,"body",1);
var tr2=opts.finder.getTr(_90c,_911,"body",2);
tr1.css("height","");
tr2.css("height","");
var _912=Math.max(tr1.height(),tr2.height());
tr1.css("height",_912);
tr2.css("height",_912);
};
};
function _913(_914){
var dc=$.data(_914,"datagrid").dc;
...
function _915(_916){
return function(e){
$.fn.datagrid.defaults.rowEvents[_916?"mouseover":"mouseout"](e);
var tt=$(e.target);
var fn=_916?"addClass":"removeClass";
if(tt.hasClass("tree-hit")){
...
var opts=$(_919).datagrid("options");
if(!tt.parent().hasClass("datagrid-cell-check")&&!opts.singleSelect&&e.shiftKey){
var rows=$(_919).treegrid("getChildren");
var idx1=$.easyui.indexOfArray(rows,opts.idField,opts.lastSelectedIndex);
var idx2=$.easyui.indexOfArray(rows,opts.idField,_918);
var from=Math.min(Math.max(idx1,0),idx2);
var to=Math.max(idx1,idx2);
var row=rows[idx2];
var td=tt.closest("td[field]",tr);
if(td.length){
var _91d=td.attr("field");
opts.onClickCell.call(_919,_918,_91d,row[_91d]);
}
$(_919).treegrid("clearSelections");
for(var i=from;i<=to;i++){
$(_919).treegrid("selectRow",rows[i][opts.idField]);
}
opts.onClickRow.call(_919,row);
}else{
...
function _91c(_91e,_91f,_920,_921){
var _922=$.data(_91e,"treegrid");
var _923=_922.checkedRows;
var opts=_922.options;
if(!opts.checkbox){
return;
}
var row=find(_91e,_91f);
if(!row.checkState){
return;
}
var tr=opts.finder.getTr(_91e,_91f);
...
if(!_921){
if(opts.onBeforeCheckNode.call(_91e,row,_920)==false){
return;
}
}
if(opts.cascadeCheck){
...
_926(_91e,row,_920?"1":"0");
}
if(!_921){
opts.onCheckNode.call(_91e,row,_920);
}
};
function _926(_927,row,flag){
var _928=$.data(_927,"treegrid");
var _929=_928.checkedRows;
var opts=_928.options;
if(!row.checkState||flag==undefined){
return;
}
var tr=opts.finder.getTr(_927,row[opts.idField]);
var ck=tr.find(".tree-checkbox");
if(!ck.length){
return;
}
...
ck.addClass("tree-checkbox"+flag);
if(flag==0){
$.easyui.removeArrayItem(_929,opts.idField,row[opts.idField]);
}else{
$.easyui.addArrayItem(_929,opts.idField,row);
}
};
function _924(_92a,row,_92b){
var flag=_92b?1:0;
_926(_92a,row,flag);
...
function _925(_92c,row){
var opts=$.data(_92c,"treegrid").options;
var prow=_92d(_92c,row[opts.idField]);
if(prow){
_926(_92c,prow,_92e(prow));
_925(_92c,prow);
}
};
function _92e(row){
...
var tr=opts.finder.getTr(_930,_931);
var ck=tr.find(".tree-checkbox");
if(opts.view.hasCheckbox(_930,row)){
if(!ck.length){
row.checkState=row.checkState||"unchecked";
$("<span class=\"tree-checkbox\"></span>").insertBefore(tr.find(".tree-title"));
}
if(row.checkState=="checked"){
_91c(_930,_931,true,true);
}else{
if(row.checkState=="unchecked"){
_91c(_930,_931,false,true);
}else{
var flag=_92e(row);
if(flag===0){
_91c(_930,_931,false,true);
...
var tr1=opts.finder.getTr(_933,_934,"body",1);
var tr2=opts.finder.getTr(_933,_934,"body",2);
var _935=$(_933).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _936=$(_933).datagrid("getColumnFields",false).length;
_937(tr1,_935);
_937(tr2,_936);
function _937(tr,_938){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_938+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _939(_93a,_93b,data,_93c,_93d){
var _93e=$.data(_93a,"treegrid");
var opts=_93e.options;
var dc=_93e.dc;
data=opts.loadFilter.call(_93a,data,_93b);
var node=find(_93a,_93b);
if(node){
var _93f=opts.finder.getTr(_93a,_93b,"body",1);
var _940=opts.finder.getTr(_93a,_93b,"body",2);
var cc1=_93f.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_940.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_93c){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_93a,_93b,data);
}
opts.view.render.call(opts.view,_93a,cc1,true);
opts.view.render.call(opts.view,_93a,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_93a,dc.footer1,true);
opts.view.renderFooter.call(opts.view,_93a,dc.footer2,false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_93a);
}
if(!_93b&&opts.pagination){
var _941=$.data(_93a,"treegrid").total;
var _942=$(_93a).datagrid("getPager");
if(_942.pagination("options").total!=_941){
_942.pagination({total:_941});
}
}
_90b(_93a);
_913(_93a);
$(_93a).treegrid("showLines");
$(_93a).treegrid("setSelectionState");
$(_93a).treegrid("autoSizeColumn");
if(!_93d){
opts.onLoadSuccess.call(_93a,node,data);
}
};
function _90a(_943,_944,_945,_946,_947){
var opts=$.data(_943,"treegrid").options;
var body=$(_943).datagrid("getPanel").find("div.datagrid-body");
if(_944==undefined&&opts.queryParams){
opts.queryParams.id=undefined;
}
if(_945){
opts.queryParams=_945;
}
var _948=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_948,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_948,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_943,_944);
if(opts.onBeforeLoad.call(_943,row,_948)==false){
return;
}
var _949=body.find("tr[node-id=\""+_944+"\"] span.tree-folder");
_949.addClass("tree-loading");
$(_943).treegrid("loading");
var _94a=opts.loader.call(_943,_948,function(data){
_949.removeClass("tree-loading");
$(_943).treegrid("loaded");
_939(_943,_944,data,_946);
if(_947){
_947();
}
},function(){
_949.removeClass("tree-loading");
$(_943).treegrid("loaded");
opts.onLoadError.apply(_943,arguments);
if(_947){
_947();
}
});
...
function _94b(_94c){
var _94d=_94e(_94c);
return _94d.length?_94d[0]:null;
};
function _94e(_94f){
return $.data(_94f,"treegrid").data;
};
function _92d(_950,_951){
var row=find(_950,_951);
if(row._parentId){
return find(_950,row._parentId);
}else{
return null;
}
};
function _90f(_952,_953){
var data=$.data(_952,"treegrid").data;
if(_953){
var _954=find(_952,_953);
data=_954?(_954.children||[]):[];
}
var _955=[];
$.easyui.forEach(data,true,function(node){
_955.push(node);
...
var tr=opts.finder.getTr(_957,_958);
var node=tr.children("td[field=\""+opts.treeField+"\"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_959,_95a){
var _95b=$.data(_959,"treegrid");
var opts=_95b.options;
var _95c=null;
$.easyui.forEach(_95b.data,true,function(node){
if(node[opts.idField]==_95a){
_95c=node;
return false;
}
});
...
function _95d(_95e,_95f){
var opts=$.data(_95e,"treegrid").options;
var row=find(_95e,_95f);
var tr=opts.finder.getTr(_95e,_95f);
...
if(opts.onBeforeCollapse.call(_95e,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
$(_95e).treegrid("autoSizeColumn");
_90b(_95e,_95f);
opts.onCollapse.call(_95e,row);
});
}else{
cc.hide();
$(_95e).treegrid("autoSizeColumn");
...
if(opts.onBeforeExpand.call(_961,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _963=tr.next("tr.treegrid-tr-tree");
if(_963.length){
var cc=_963.children("td").children("div");
_964(cc);
}else{
_932(_961,row[opts.idField]);
var _963=tr.next("tr.treegrid-tr-tree");
var cc=_963.children("td").children("div");
cc.hide();
var _965=$.extend({},opts.queryParams||{});
_965.id=row[opts.idField];
_90a(_961,row[opts.idField],_965,true,function(){
if(cc.is(":empty")){
_963.remove();
}else{
_964(cc);
...
$(_961).treegrid("autoSizeColumn");
_90b(_961,_962);
opts.onExpand.call(_961,row);
});
}else{
cc.show();
$(_961).treegrid("autoSizeColumn");
...
var _976=$.data(_974,"treegrid");
var opts=_976.options;
if(_975.parent){
var tr=opts.finder.getTr(_974,_975.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_932(_974,_975.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _977=cell.children("span.tree-icon");
if(_977.hasClass("tree-file")){
_977.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_977);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_939(_974,_975.parent,_975.data,_976.data.length>0,true);
};
function _978(_979,_97a){
var ref=_97a.before||_97a.after;
var opts=$.data(_979,"treegrid").options;
var _97b=_92d(_979,ref);
_973(_979,{parent:(_97b?_97b[opts.idField]:null),data:[_97a.data]});
var _97c=_97b?_97b.children:$(_979).treegrid("getRoots");
for(var i=0;i<_97c.length;i++){
if(_97c[i][opts.idField]==ref){
var _97d=_97c[_97c.length-1];
_97c.splice(_97a.before?i:(i+1),0,_97d);
_97c.splice(_97c.length-1,1);
break;
}
}
_97e(true);
_97e(false);
_913(_979);
$(_979).treegrid("showLines");
function _97e(_97f){
var _980=_97f?1:2;
var tr=opts.finder.getTr(_979,_97a.data[opts.idField],"body",_980);
var _981=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_979,ref,"body",_980);
if(_97a.before){
...
var _985=$.data(_983,"treegrid");
var opts=_985.options;
var prow=_92d(_983,_984);
$(_983).datagrid("deleteRow",_984);
$.easyui.removeArrayItem(_985.checkedRows,opts.idField,_984);
_913(_983);
if(prow){
_92f(_983,prow[opts.idField]);
}
_985.total-=1;
$(_983).datagrid("getPager").pagination("refresh",{total:_985.total});
$(_983).treegrid("showLines");
};
function _986(_987){
var t=$(_987);
...
var _988=t.treegrid("getRoots");
if(_988.length>1){
_989(_988[0]).addClass("tree-root-first");
}else{
if(_988.length==1){
_989(_988[0]).addClass("tree-root-one");
}
}
_98a(_988);
_98b(_988);
function _98a(_98c){
$.map(_98c,function(node){
...
if(_98c.length){
var cell=_989(_98c[_98c.length-1]);
cell.addClass("tree-node-last");
cell.find(".tree-join").removeClass("tree-join").addClass("tree-joinbottom");
}
};
function _98b(_98d){
$.map(_98d,function(node){
if(node.children&&node.children.length){
_98b(node.children);
}
});
for(var i=0;i<_98d.length-1;i++){
var node=_98d[i];
var _98e=t.treegrid("getLevel",node[opts.idField]);
var tr=opts.finder.getTr(_987,node[opts.idField]);
var cc=tr.next().find("tr.datagrid-row td[field=\""+opts.treeField+"\"] div.datagrid-cell");
cc.find("span:eq("+(_98e-1)+")").addClass("tree-line");
}
};
function _989(node){
var tr=opts.finder.getTr(_987,node[opts.idField]);
...
$.fn.treegrid=function(_98f,_990){
if(typeof _98f=="string"){
var _991=$.fn.treegrid.methods[_98f];
if(_991){
return _991(this,_990);
}else{
return this.datagrid(_98f,_990);
}
}
_98f=_98f||{};
return this.each(function(){
var _992=$.data(this,"treegrid");
if(_992){
$.extend(_992.options,_98f);
}else{
_992=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_98f),data:[],checkedRows:[],tmpIds:[]});
}
_8fa(this);
if(_992.options.data){
$(this).treegrid("loadData",_992.options.data);
}
_90a(this);
});
};
...
},resize:function(jq,_993){
return jq.each(function(){
$(this).datagrid("resize",_993);
});
},fixRowHeight:function(jq,_994){
return jq.each(function(){
_90b(this,_994);
});
},loadData:function(jq,data){
return jq.each(function(){
_939(this,data.parent,data);
});
},load:function(jq,_995){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_995);
});
...
_996=$.extend({},opts.queryParams);
_996.id=id;
}
if(_996.id){
var node=$(this).treegrid("find",_996.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_996;
var tr=opts.finder.getTr(this,_996.id);
...
},reloadFooter:function(jq,_997){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_997){
$.data(this,"treegrid").footer=_997;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_998){
return jq.each(function(){
_973(this,_998);
});
},insert:function(jq,_999){
return jq.each(function(){
_978(this,_999);
});
...
},update:function(jq,_99a){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var row=_99a.row;
opts.view.updateRow.call(opts.view,this,_99a.id,row);
if(row.checked!=undefined){
row=find(this,_99a.id);
...
var _99b=$(this).data("treegrid");
for(var i=0;i<_99b.tmpIds.length;i++){
_91c(this,_99b.tmpIds[i],true,true);
}
_99b.tmpIds=[];
});
},getCheckedNodes:function(jq,_99c){
_99c=_99c||"checked";
var rows=[];
$.easyui.forEach(jq.data("treegrid").checkedRows,false,function(row){
if(row.checkState==_99c){
rows.push(row);
}
});
return rows;
...
return jq.each(function(){
var _99d=this;
var opts=$(_99d).treegrid("options");
$(_99d).datagrid("clearChecked");
$.map($(_99d).treegrid("getCheckedNodes"),function(row){
_91c(_99d,row[opts.idField],false,true);
});
});
}};
$.fn.treegrid.parseOptions=function(_99e){
return $.extend({},$.fn.datagrid.parseOptions(_99e),$.parser.parseOptions(_99e,["treeField",{checkbox:"boolean",cascadeCheck:"boolean",onlyLeafCheck:"boolean"},{animate:"boolean"}]));
};
var _99f=$.extend({},$.fn.datagrid.defaults.view,{render:function(_9a0,_9a1,_9a2){
var opts=$.data(_9a0,"treegrid").options;
var _9a3=$(_9a0).datagrid("getColumnFields",_9a2);
var _9a4=$.data(_9a0,"datagrid").rowIdPrefix;
if(_9a2){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _9a5=_9a6.call(this,_9a2,this.treeLevel,this.treeNodes);
$(_9a1).append(_9a5.join(""));
}
function _9a6(_9a7,_9a8,_9a9){
var _9aa=$(_9a0).treegrid("getParent",_9a9[0][opts.idField]);
var _9ab=(_9aa?_9aa.children.length:$(_9a0).treegrid("getRoots").length)-_9a9.length;
var _9ac=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_9a9.length;i++){
var row=_9a9[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_9a0,row):"";
var cs=this.getStyleValue(css);
var cls="class=\"datagrid-row "+(_9ab++%2&&opts.striped?"datagrid-row-alt ":" ")+cs.c+"\"";
var _9ad=cs.s?"style=\""+cs.s+"\"":"";
var _9ae=_9a4+"-"+(_9a7?1:2)+"-"+row[opts.idField];
_9ac.push("<tr id=\""+_9ae+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_9ad+">");
_9ac=_9ac.concat(view.renderRow.call(view,_9a0,_9a3,_9a7,_9a8,row));
_9ac.push("</tr>");
if(row.children&&row.children.length){
var tt=_9a6.call(this,_9a7,_9a8+1,row.children);
var v=row.state=="closed"?"none":"block";
_9ac.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_9a3.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_9ac=_9ac.concat(tt);
_9ac.push("</div></td></tr>");
}
}
_9ac.push("</tbody></table>");
return _9ac;
};
},renderFooter:function(_9af,_9b0,_9b1){
var opts=$.data(_9af,"treegrid").options;
var rows=$.data(_9af,"treegrid").footer||[];
var _9b2=$(_9af).datagrid("getColumnFields",_9b1);
var _9b3=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_9b3.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_9b3.push(this.renderRow.call(this,_9af,_9b2,_9b1,0,row));
_9b3.push("</tr>");
}
_9b3.push("</tbody></table>");
$(_9b0).html(_9b3.join(""));
},renderRow:function(_9b4,_9b5,_9b6,_9b7,row){
var _9b8=$.data(_9b4,"treegrid");
var opts=_9b8.options;
var cc=[];
if(_9b6&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_9b5.length;i++){
var _9b9=_9b5[i];
var col=$(_9b4).datagrid("getColumnOption",_9b9);
if(col){
var css=col.styler?(col.styler(row[_9b9],row)||""):"";
var cs=this.getStyleValue(css);
var cls=cs.c?"class=\""+cs.c+"\"":"";
var _9ba=col.hidden?"style=\"display:none;"+cs.s+"\"":(cs.s?"style=\""+cs.s+"\"":"");
cc.push("<td field=\""+_9b9+"\" "+cls+" "+_9ba+">");
var _9ba="";
if(!col.checkbox){
if(col.align){
_9ba+="text-align:"+col.align+";";
}
if(!opts.nowrap){
_9ba+="white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_9ba+="height:auto;";
}
...
cc.push(" name=\""+_9b9+"\" value=\""+(row[_9b9]!=undefined?row[_9b9]:"")+"\">");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_9b9],row);
}else{
val=row[_9b9];
}
if(_9b9==opts.treeField){
for(var j=0;j<_9b7;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
if(this.hasCheckbox(_9b4,row)){
var flag=0;
var crow=$.easyui.getArrayItem(_9b8.checkedRows,opts.idField,row[opts.idField]);
if(crow){
flag=crow.checkState=="checked"?1:2;
row.checkState=crow.checkState;
row.checked=crow.checked;
$.easyui.addArrayItem(_9b8.checkedRows,opts.idField,row);
}else{
var prow=$.easyui.getArrayItem(_9b8.checkedRows,opts.idField,row._parentId);
...
if(row.checked){
$.easyui.addArrayItem(_9b8.tmpIds,row[opts.idField]);
}
}
...
return cc.join("");
},hasCheckbox:function(_9bb,row){
var opts=$.data(_9bb,"treegrid").options;
if(opts.checkbox){
if($.isFunction(opts.checkbox)){
if(opts.checkbox.call(_9bb,row)){
return true;
}else{
return false;
}
...
},refreshRow:function(_9bc,id){
this.updateRow.call(this,_9bc,id,{});
},updateRow:function(_9bd,id,row){
var opts=$.data(_9bd,"treegrid").options;
var _9be=$(_9bd).treegrid("find",id);
$.extend(_9be,row);
var _9bf=$(_9bd).treegrid("getLevel",id)-1;
var _9c0=opts.rowStyler?opts.rowStyler.call(_9bd,_9be):"";
var _9c1=$.data(_9bd,"datagrid").rowIdPrefix;
var _9c2=_9be[opts.idField];
function _9c3(_9c4){
var _9c5=$(_9bd).treegrid("getColumnFields",_9c4);
var tr=opts.finder.getTr(_9bd,id,"body",(_9c4?1:2));
var _9c6=tr.find("div.datagrid-cell-rownumber").html();
var _9c7=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_9bd,_9c5,_9c4,_9bf,_9be));
tr.attr("style",_9c0||"");
tr.find("div.datagrid-cell-rownumber").html(_9c6);
if(_9c7){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
if(_9c2!=id){
tr.attr("id",_9c1+"-"+(_9c4?1:2)+"-"+_9c2);
tr.attr("node-id",_9c2);
}
};
_9c3.call(this,true);
_9c3.call(this,false);
$(_9bd).treegrid("fixRowHeight",id);
},deleteRow:function(_9c8,id){
var opts=$.data(_9c8,"treegrid").options;
var tr=opts.finder.getTr(_9c8,id);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _9c9=del(id);
if(_9c9){
if(_9c9.children.length==0){
tr=opts.finder.getTr(_9c8,_9c9[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
this.setEmptyMsg(_9c8);
function del(id){
var cc;
var _9ca=$(_9c8).treegrid("getParent",id);
if(_9ca){
cc=_9ca.children;
}else{
cc=$(_9c8).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
},onBeforeRender:function(_9cb,_9cc,data){
if($.isArray(_9cc)){
data={total:_9cc.length,rows:_9cc};
_9cc=null;
}
if(!data){
return false;
}
var _9cd=$.data(_9cb,"treegrid");
var opts=_9cd.options;
if(data.length==undefined){
if(data.footer){
_9cd.footer=data.footer;
}
if(data.total){
_9cd.total=data.total;
}
data=this.transfer(_9cb,_9cc,data.rows);
}else{
...
row._parentId=_9d0;
if(row.children&&row.children.length){
_9ce(row.children,row[opts.idField]);
}
}
};
_9ce(data,_9cc);
...
this.sort(_9cb,data);
this.treeNodes=data;
this.treeLevel=$(_9cb).treegrid("getLevel",_9cc);
var node=find(_9cb,_9cc);
if(node){
if(node.children){
...
_9cd.data=_9cd.data.concat(data);
}
},sort:function(_9d1,data){
var opts=$.data(_9d1,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _9d2=opts.sortName.split(",");
var _9d3=opts.sortOrder.split(",");
_9d4(data);
}
function _9d4(rows){
...
var sn=_9d2[i];
var so=_9d3[i];
var col=$(_9d1).treegrid("getColumnOption",sn);
var _9d5=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_9d5(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _9d6=rows[i].children;
if(_9d6&&_9d6.length){
_9d4(_9d6);
}
}
};
},transfer:function(_9d7,_9d8,data){
var opts=$.data(_9d7,"treegrid").options;
var rows=$.extend([],data);
var _9d9=_9da(_9d8,rows);
var toDo=$.extend([],_9d9);
while(toDo.length){
var node=toDo.shift();
var _9db=_9da(node[opts.idField],rows);
if(_9db.length){
if(node.children){
node.children=node.children.concat(_9db);
}else{
node.children=_9db;
}
toDo=toDo.concat(_9db);
}
}
return _9d9;
function _9da(_9dc,rows){
var rr=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
if(row._parentId==_9dc){
rr.push(row);
rows.splice(i,1);
i--;
}
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,animate:false,singleSelect:true,view:_99f,rowEvents:$.extend({},$.fn.datagrid.defaults.rowEvents,{mouseover:_915(true),mouseout:_915(false),click:_917}),loader:function(_9dd,_9de,_9df){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_9dd,dataType:"json",success:function(data){
_9de(data);
},error:function(){
_9df.apply(this,arguments);
}});
},loadFilter:function(data,_9e0){
return data;
},finder:{getTr:function(_9e1,id,type,_9e2){
type=type||"body";
_9e2=_9e2||0;
var dc=$.data(_9e1,"datagrid").dc;
if(_9e2==0){
var opts=$.data(_9e1,"treegrid").options;
var tr1=opts.finder.getTr(_9e1,id,type,1);
var tr2=opts.finder.getTr(_9e1,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_9e1,"datagrid").rowIdPrefix+"-"+_9e2+"-"+id);
if(!tr.length){
tr=(_9e2==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_9e2==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_9e2==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_9e2==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_9e2==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_9e2==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_9e2==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_9e2==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_9e3,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_9e3).treegrid("find",id);
},getRows:function(_9e4){
return $(_9e4).treegrid("getChildren");
}},onBeforeLoad:function(row,_9e5){
...
},onClickCell:function(_9e6,row){
},onDblClickCell:function(_9e7,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_9e8){
},onCancelEdit:function(row){
},onBeforeCheckNode:function(row,_9e9){
},onCheckNode:function(row,_9ea){
}});
})(jQuery);
(function($){
function _9eb(_9ec){
var opts=$.data(_9ec,"datalist").options;
$(_9ec).datagrid($.extend({},opts,{cls:"datalist"+(opts.lines?" datalist-lines":""),frozenColumns:(opts.frozenColumns&&opts.frozenColumns.length)?opts.frozenColumns:(opts.checkbox?[[{field:"_ck",checkbox:true}]]:undefined),columns:(opts.columns&&opts.columns.length)?opts.columns:[[{field:opts.textField,width:"100%",formatter:function(_9ed,row,_9ee){
return opts.textFormatter?opts.textFormatter(_9ed,row,_9ee):_9ed;
}}]]}));
};
var _9ef=$.extend({},$.fn.datagrid.defaults.view,{render:function(_9f0,_9f1,_9f2){
var _9f3=$.data(_9f0,"datagrid");
var opts=_9f3.options;
if(opts.groupField){
var g=this.groupRows(_9f0,_9f3.data.rows);
this.groups=g.groups;
_9f3.data.rows=g.rows;
var _9f4=[];
for(var i=0;i<g.groups.length;i++){
_9f4.push(this.renderGroup.call(this,_9f0,i,g.groups[i],_9f2));
}
$(_9f1).html(_9f4.join(""));
}else{
$(_9f1).html(this.renderTable(_9f0,0,_9f3.data.rows,_9f2));
}
},renderGroup:function(_9f5,_9f6,_9f7,_9f8){
var _9f9=$.data(_9f5,"datagrid");
var opts=_9f9.options;
var _9fa=$(_9f5).datagrid("getColumnFields",_9f8);
var _9fb=[];
_9fb.push("<div class=\"datagrid-group\" group-index="+_9f6+">");
if(!_9f8){
_9fb.push("<span class=\"datagrid-group-title\">");
_9fb.push(opts.groupFormatter.call(_9f5,_9f7.value,_9f7.rows));
_9fb.push("</span>");
}
_9fb.push("</div>");
_9fb.push(this.renderTable(_9f5,_9f7.startIndex,_9f7.rows,_9f8));
return _9fb.join("");
},groupRows:function(_9fc,rows){
var _9fd=$.data(_9fc,"datagrid");
var opts=_9fd.options;
var _9fe=[];
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _9ff=_a00(row[opts.groupField]);
if(!_9ff){
_9ff={value:row[opts.groupField],rows:[row]};
_9fe.push(_9ff);
}else{
_9ff.rows.push(row);
}
...
var _9ff=_9fe[i];
_9ff.startIndex=_a01;
_a01+=_9ff.rows.length;
rows=rows.concat(_9ff.rows);
}
return {groups:_9fe,rows:rows};
function _a00(_a02){
for(var i=0;i<_9fe.length;i++){
var _a03=_9fe[i];
if(_a03.value==_a02){
...
$.fn.datalist=function(_a04,_a05){
if(typeof _a04=="string"){
var _a06=$.fn.datalist.methods[_a04];
if(_a06){
return _a06(this,_a05);
}else{
return this.datagrid(_a04,_a05);
}
}
_a04=_a04||{};
return this.each(function(){
var _a07=$.data(this,"datalist");
if(_a07){
$.extend(_a07.options,_a04);
}else{
var opts=$.extend({},$.fn.datalist.defaults,$.fn.datalist.parseOptions(this),_a04);
opts.columns=$.extend(true,[],opts.columns);
_a07=$.data(this,"datalist",{options:opts});
}
_9eb(this);
if(!_a07.options.data){
...
$.fn.datalist.parseOptions=function(_a08){
return $.extend({},$.fn.datagrid.parseOptions(_a08),$.parser.parseOptions(_a08,["valueField","textField","groupField",{checkbox:"boolean",lines:"boolean"}]));
};
$.fn.datalist.parseData=function(_a09){
var opts=$.data(_a09,"datalist").options;
var data={total:0,rows:[]};
$(_a09).children().each(function(){
var _a0a=$.parser.parseOptions(this,["value","group"]);
var row={};
var html=$(this).html();
row[opts.valueField]=_a0a.value!=undefined?_a0a.value:html;
row[opts.textField]=html;
if(opts.groupField){
row[opts.groupField]=_a0a.group;
}
data.total++;
data.rows.push(row);
});
...
$.fn.datalist.defaults=$.extend({},$.fn.datagrid.defaults,{fitColumns:true,singleSelect:true,showHeader:false,checkbox:false,lines:false,valueField:"value",textField:"text",groupField:"",view:_9ef,textFormatter:function(_a0b,row){
return _a0b;
},groupFormatter:function(_a0c,rows){
return _a0c;
}});
})(jQuery);
(function($){
...
function _a0e(_a0f){
var _a10=$.data(_a0f,"combo");
var opts=_a10.options;
if(!_a10.panel){
_a10.panel=$("<div class=\"combo-panel\"></div>").appendTo("body");
_a10.panel.panel({minWidth:opts.panelMinWidth,maxWidth:opts.panelMaxWidth,minHeight:opts.panelMinHeight,maxHeight:opts.panelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _a11=$(this).panel("options").comboTarget;
var _a12=$.data(_a11,"combo");
if(_a12){
_a12.options.onShowPanel.call(_a11);
}
},onBeforeClose:function(){
_a0d($(this).parent());
},onClose:function(){
var _a13=$(this).panel("options").comboTarget;
var _a14=$(_a13).data("combo");
if(_a14){
_a14.options.onHidePanel.call(_a13);
}
}});
}
var _a15=$.extend(true,[],opts.icons);
if(opts.hasDownArrow){
_a15.push({iconCls:"combo-arrow",handler:function(e){
_a19(e.data.target);
}});
}
$(_a0f).addClass("combo-f").textbox($.extend({},opts,{icons:_a15,onChange:function(){
}}));
$(_a0f).attr("comboName",$(_a0f).attr("textboxName"));
_a10.combo=$(_a0f).next();
_a10.combo.addClass("combo");
};
function _a16(_a17){
...
$(_a17).textbox("destroy");
};
function _a19(_a1a){
var _a1b=$.data(_a1a,"combo").panel;
if(_a1b.is(":visible")){
var _a1c=_a1b.combo("combo");
_a1d(_a1c);
if(_a1c!=_a1a){
$(_a1a).combo("showPanel");
}
}else{
var p=$(_a1a).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(_a1b).not(p).panel("close");
$(_a1a).combo("showPanel");
}
$(_a1a).combo("textbox").focus();
};
function _a0d(_a1e){
$(_a1e).find(".combo-f").each(function(){
...
function _a23(e){
var _a24=e.data.target;
var t=$(_a24);
var _a25=t.data("combo");
var opts=t.combo("options");
_a25.panel.panel("options").comboTarget=_a24;
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_a24,e);
break;
case 40:
opts.keyHandler.down.call(_a24,e);
break;
case 37:
opts.keyHandler.left.call(_a24,e);
break;
case 39:
opts.keyHandler.right.call(_a24,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_a24,e);
return false;
case 9:
case 27:
_a1d(_a24);
...
if(opts.editable){
if(_a25.timer){
clearTimeout(_a25.timer);
}
_a25.timer=setTimeout(function(){
var q=t.combo("getText");
if(_a25.previousText!=q){
_a25.previousText=q;
t.combo("showPanel");
opts.keyHandler.query.call(_a24,q,e);
t.combo("validate");
}
},opts.delay);
}
...
function _a26(_a27){
var _a28=$.data(_a27,"combo");
var _a29=_a28.combo;
var _a2a=_a28.panel;
var opts=$(_a27).combo("options");
var _a2b=_a2a.panel("options");
_a2b.comboTarget=_a27;
if(_a2b.closed){
_a2a.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_a2a.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_a29._outerWidth()),height:opts.panelHeight});
_a2a.panel("panel").hide();
_a2a.panel("open");
}
(function(){
if(_a2b.comboTarget==_a27&&_a2a.is(":visible")){
_a2a.panel("move",{left:_a2c(),top:_a2d()});
setTimeout(arguments.callee,200);
}
})();
function _a2c(){
var left=_a29.offset().left;
if(opts.panelAlign=="right"){
left+=_a29._outerWidth()-_a2a._outerWidth();
}
if(left+_a2a._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_a2a._outerWidth();
}
if(left<0){
left=0;
}
...
function _a2d(){
var top=_a29.offset().top+_a29._outerHeight();
if(top+_a2a._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_a29.offset().top-_a2a._outerHeight();
}
if(top<$(document).scrollTop()){
top=_a29.offset().top+_a29._outerHeight();
}
return top;
};
};
function _a1d(_a2e){
var _a2f=$.data(_a2e,"combo").panel;
_a2f.panel("close");
};
function _a30(_a31,text){
var _a32=$.data(_a31,"combo");
var _a33=$(_a31).textbox("getText");
if(_a33!=text){
$(_a31).textbox("setText",text);
}
_a32.previousText=text;
};
function _a34(_a35){
var _a36=$.data(_a35,"combo");
var opts=_a36.options;
var _a37=$(_a35).next();
var _a38=[];
_a37.find(".textbox-value").each(function(){
_a38.push($(this).val());
});
if(opts.multivalue){
return _a38;
}else{
return _a38.length?_a38[0].split(opts.separator):_a38;
}
};
function _a39(_a3a,_a3b){
var _a3c=$.data(_a3a,"combo");
var _a3d=_a3c.combo;
var opts=$(_a3a).combo("options");
if(!$.isArray(_a3b)){
_a3b=_a3b.split(opts.separator);
}
var _a3e=_a34(_a3a);
_a3d.find(".textbox-value").remove();
if(_a3b.length){
if(opts.multivalue){
...
_a3f(_a3b.join(opts.separator));
}
}
function _a3f(_a40){
var name=$(_a3a).attr("textboxName")||"";
var _a41=$("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_a3d);
_a41.attr("name",name);
if(opts.disabled){
_a41.attr("disabled","disabled");
}
_a41.val(_a40);
};
var _a42=(function(){
if(_a3e.length!=_a3b.length){
return true;
}
for(var i=0;i<_a3b.length;i++){
if(_a3b[i]!=_a3e[i]){
...
if(_a42){
$(_a3a).val(_a3b.join(opts.separator));
if(opts.multiple){
opts.onChange.call(_a3a,_a3b,_a3e);
}else{
opts.onChange.call(_a3a,_a3b[0],_a3e[0]);
}
$(_a3a).closest("form").trigger("_change",[_a3a]);
}
};
function _a43(_a44){
var _a45=_a34(_a44);
...
function _a49(_a4a){
var opts=$.data(_a4a,"combo").options;
var _a4b=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
_a39(_a4a,opts.value?opts.value:[]);
}else{
_a46(_a4a,opts.value);
}
opts.onChange=_a4b;
};
$.fn.combo=function(_a4c,_a4d){
if(typeof _a4c=="string"){
var _a4e=$.fn.combo.methods[_a4c];
if(_a4e){
return _a4e(this,_a4d);
}else{
return this.textbox(_a4c,_a4d);
}
}
_a4c=_a4c||{};
return this.each(function(){
var _a4f=$.data(this,"combo");
if(_a4f){
$.extend(_a4f.options,_a4c);
if(_a4c.value!=undefined){
_a4f.options.originalValue=_a4c.value;
}
}else{
_a4f=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_a4c),previousText:""});
if(_a4f.options.multiple&&_a4f.options.value==""){
_a4f.options.originalValue=[];
}else{
_a4f.options.originalValue=_a4f.options.value;
}
}
_a0e(this);
_a49(this);
...
return _a34(jq[0]);
},setValues:function(jq,_a50){
return jq.each(function(){
_a39(this,_a50);
});
},getValue:function(jq){
return _a43(jq[0]);
},setValue:function(jq,_a51){
return jq.each(function(){
_a46(this,_a51);
});
}};
$.fn.combo.parseOptions=function(_a52){
var t=$(_a52);
return $.extend({},$.fn.textbox.parseOptions(_a52),$.parser.parseOptions(_a52,["separator","panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",multivalue:"boolean",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_a1f,keydown:_a23,paste:_a23,drop:_a23},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
},onChange:function(_a53,_a54){
}});
})(jQuery);
(function($){
function _a55(_a56,_a57){
var _a58=$.data(_a56,"combobox");
return $.easyui.indexOfArray(_a58.data,_a58.options.valueField,_a57);
};
function _a59(_a5a,_a5b){
var opts=$.data(_a5a,"combobox").options;
var _a5c=$(_a5a).combo("panel");
var item=opts.finder.getEl(_a5a,_a5b);
if(item.length){
if(item.position().top<=0){
var h=_a5c.scrollTop()+item.position().top;
_a5c.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_a5c.height()){
var h=_a5c.scrollTop()+item.position().top+item.outerHeight()-_a5c.height();
_a5c.scrollTop(h);
}
}
}
_a5c.triggerHandler("scroll");
};
function nav(_a5d,dir){
var opts=$.data(_a5d,"combobox").options;
var _a5e=$(_a5d).combobox("panel");
var item=_a5e.children("div.combobox-item-hover");
if(!item.length){
item=_a5e.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _a5f="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _a60="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_a5e.children(dir=="next"?_a5f:_a60);
}else{
if(dir=="next"){
item=item.nextAll(_a5f);
if(!item.length){
item=_a5e.children(_a5f);
}
}else{
item=item.prevAll(_a5f);
if(!item.length){
item=_a5e.children(_a60);
}
}
}
if(item.length){
...
if(row){
$(_a5d).combobox("scrollTo",row[opts.valueField]);
if(opts.selectOnNavigation){
_a61(_a5d,row[opts.valueField]);
}
}
}
};
...
var _a65=$(_a62).combo("getValues");
if($.inArray(_a63+"",_a65)==-1){
if(opts.multiple){
_a65.push(_a63);
}else{
_a65=[_a63];
...
var _a6a=$(_a68).combo("getValues");
var _a6b=$.inArray(_a69+"",_a6a);
if(_a6b>=0){
_a6a.splice(_a6b,1);
_a66(_a68,_a6a);
}
};
function _a66(_a6c,_a6d,_a6e){
var opts=$.data(_a6c,"combobox").options;
var _a6f=$(_a6c).combo("panel");
if(!$.isArray(_a6d)){
...
var _a70=$(_a6c).combo("getValues");
if(_a6f.is(":visible")){
_a6f.find(".combobox-item-selected").each(function(){
var row=opts.finder.getRow(_a6c,$(this));
if(row){
if($.easyui.indexOfArray(_a70,row[opts.valueField])==-1){
...
$.map(_a70,function(v){
if($.easyui.indexOfArray(_a6d,v)==-1){
var el=opts.finder.getEl(_a6c,v);
if(el.hasClass("combobox-item-selected")){
el.removeClass("combobox-item-selected");
opts.onUnselect.call(_a6c,opts.finder.getRow(_a6c,v));
}
}
});
var _a71=null;
...
var v=_a6d[i];
var s=v;
var row=opts.finder.getRow(_a6c,v);
if(row){
...
opts.onSelect.call(_a6c,row);
}
}else{
s=_a72(v,opts.mappingRows)||v;
}
vv.push(v);
ss.push(s);
}
if(!_a6e){
$(_a6c).combo("setText",ss.join(opts.separator));
}
if(opts.showItemIcon){
var tb=$(_a6c).combobox("textbox");
tb.removeClass("textbox-bgicon "+opts.textboxIconCls);
if(_a71&&_a71.iconCls){
tb.addClass("textbox-bgicon "+_a71.iconCls);
opts.textboxIconCls=_a71.iconCls;
}
}
$(_a6c).combo("setValues",vv);
_a6f.triggerHandler("scroll");
function _a72(_a73,a){
var item=$.easyui.getArrayItem(a,opts.valueField,_a73);
return item?item[opts.textField]:undefined;
};
};
function _a74(_a75,data,_a76){
var _a77=$.data(_a75,"combobox");
var opts=_a77.options;
_a77.data=opts.loadFilter.call(_a75,data);
opts.view.render.call(opts.view,_a75,$(_a75).combo("panel"),_a77.data);
var vv=$(_a75).combobox("getValues");
$.easyui.forEach(_a77.data,false,function(row){
if(row["selected"]){
...
_a66(_a75,vv.length?[vv[vv.length-1]]:[],_a76);
}
opts.onLoadSuccess.call(_a75,data);
};
function _a78(_a79,url,_a7a,_a7b){
var opts=$.data(_a79,"combobox").options;
if(url){
opts.url=url;
}
_a7a=$.extend({},opts.queryParams,_a7a||{});
if(opts.onBeforeLoad.call(_a79,_a7a)==false){
return;
}
opts.loader.call(_a79,_a7a,function(data){
_a74(_a79,data,_a7b);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _a7c(_a7d,q){
var _a7e=$.data(_a7d,"combobox");
var opts=_a7e.options;
var _a7f=$();
var qq=opts.multiple?q.split(opts.separator):[q];
if(opts.mode=="remote"){
_a80(qq);
_a78(_a7d,null,{q:q},true);
}else{
var _a81=$(_a7d).combo("panel");
_a81.find(".combobox-item-hover").removeClass("combobox-item-hover");
_a81.find(".combobox-item,.combobox-group").hide();
var data=_a7e.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_a7d,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_a7d,v).show();
...
if(opts.groupField&&_a83!=g){
opts.finder.getGroupEl(_a7d,g).show();
_a83=g;
}
}
}
...
function _a80(vv){
if(opts.reversed){
_a7f.addClass("combobox-item-hover");
}else{
_a66(_a7d,opts.multiple?(q?vv:[]):vv,true);
}
};
};
function _a84(_a85){
...
var _a86=t.combobox("panel");
var item=_a86.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_a85,item);
var _a87=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_a87);
}else{
t.combobox("select",_a87);
}
}else{
t.combobox("select",_a87);
}
...
function _a88(_a89){
var _a8a=$.data(_a89,"combobox");
var opts=_a8a.options;
$(_a89).addClass("combobox-f");
$(_a89).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_a66(this,$(this).combobox("getValues"),true);
$(this).combobox("scrollTo",$(this).combobox("getValue"));
opts.onShowPanel.call(this);
}}));
var p=$(_a89).combo("panel");
p.unbind(".combobox");
for(var _a8b in opts.panelEvents){
p.bind(_a8b+".combobox",{target:_a89},opts.panelEvents[_a8b]);
}
};
function _a8c(e){
...
function _a8e(e){
var _a8f=$(this).panel("options").comboTarget;
if(!_a8f){
return;
}
var opts=$(_a8f).combobox("options");
var item=$(e.target).closest("div.combobox-item");
...
opts.onClick.call(_a8f,row);
var _a90=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
_a67(_a8f,_a90);
}else{
...
$(_a8f).combobox("setValue",_a90).combobox("hidePanel");
}
e.stopPropagation();
};
function _a91(e){
var _a92=$(this).panel("options").comboTarget;
if(!_a92){
return;
}
var opts=$(_a92).combobox("options");
if(opts.groupPosition=="sticky"){
var _a93=$(this).children(".combobox-stick");
if(!_a93.length){
_a93=$("<div class=\"combobox-stick\"></div>").appendTo(this);
}
_a93.hide();
var _a94=$(_a92).data("combobox");
$(this).children(".combobox-group:visible").each(function(){
var g=$(this);
var _a95=opts.finder.getGroup(_a92,g);
var _a96=_a94.data[_a95.startIndex+_a95.count-1];
var last=opts.finder.getEl(_a92,_a96[opts.valueField]);
if(g.position().top<0&&last.position().top>0){
_a93.show().html(g.html());
return false;
}
});
}
};
$.fn.combobox=function(_a97,_a98){
if(typeof _a97=="string"){
var _a99=$.fn.combobox.methods[_a97];
if(_a99){
return _a99(this,_a98);
}else{
return this.combo(_a97,_a98);
}
}
_a97=_a97||{};
return this.each(function(){
var _a9a=$.data(this,"combobox");
if(_a9a){
$.extend(_a9a.options,_a97);
}else{
_a9a=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_a97),data:[]});
}
_a88(this);
if(_a9a.options.data){
_a74(this,_a9a.options.data);
}else{
...
var _a9b=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_a9b.width,height:_a9b.height,originalValue:_a9b.originalValue,disabled:_a9b.disabled,readonly:_a9b.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},setValues:function(jq,_a9c){
return jq.each(function(){
var opts=$(this).combobox("options");
if($.isArray(_a9c)){
_a9c=$.map(_a9c,function(_a9d){
if(_a9d&&typeof _a9d=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.valueField,_a9d);
return _a9d[opts.valueField];
}else{
return _a9d;
}
});
...
},setValue:function(jq,_a9e){
return jq.each(function(){
$(this).combobox("setValues",$.isArray(_a9e)?_a9e:[_a9e]);
});
},clear:function(jq){
return jq.each(function(){
_a66(this,[]);
...
},select:function(jq,_a9f){
return jq.each(function(){
_a61(this,_a9f);
});
},unselect:function(jq,_aa0){
return jq.each(function(){
_a67(this,_aa0);
});
},scrollTo:function(jq,_aa1){
return jq.each(function(){
_a59(this,_aa1);
});
}};
$.fn.combobox.parseOptions=function(_aa2){
var t=$(_aa2);
return $.extend({},$.fn.combo.parseOptions(_aa2),$.parser.parseOptions(_aa2,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:"boolean"}]));
};
$.fn.combobox.parseData=function(_aa3){
var data=[];
var opts=$(_aa3).combobox("options");
$(_aa3).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _aa4=$(this).attr("label");
...
row[opts.groupField]=_aa6;
}
data.push(row);
};
};
var _aa7=0;
var _aa8={render:function(_aa9,_aaa,data){
var _aab=$.data(_aa9,"combobox");
var opts=_aab.options;
_aa7++;
_aab.itemIdPrefix="_easyui_combobox_i"+_aa7;
_aab.groupIdPrefix="_easyui_combobox_g"+_aa7;
_aab.groups=[];
var dd=[];
var _aac=undefined;
for(var i=0;i<data.length;i++){
...
if(_aac!=g){
_aac=g;
_aab.groups.push({value:g,startIndex:i,count:1});
dd.push("<div id=\""+(_aab.groupIdPrefix+"_"+(_aab.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_aa9,g):g);
dd.push("</div>");
}else{
_aab.groups[_aab.groups.length-1].count++;
}
}else{
_aac=undefined;
}
var cls="combobox-item"+(row.disabled?" combobox-item-disabled":"")+(g?" combobox-gitem":"");
dd.push("<div id=\""+(_aab.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_aa9,row):s);
dd.push("</div>");
}
$(_aaa).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_aad){
return _aad;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,unselectedValues:[],mappingRows:[],view:_aa8,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
var _aae=e.data.target;
var opts=$(_aae).combobox("options");
if(opts.reversed||opts.limitToList){
if(opts.blurTimer){
clearTimeout(opts.blurTimer);
}
opts.blurTimer=setTimeout(function(){
var _aaf=$(_aae).parent().length;
if(_aaf){
if(opts.reversed){
$(_aae).combobox("setValues",$(_aae).combobox("getValues"));
}else{
if(opts.limitToList){
var vv=[];
$.map($(_aae).combobox("getValues"),function(v){
var _ab0=$.easyui.indexOfArray($(_aae).combobox("getData"),opts.valueField,v);
if(_ab0>=0){
vv.push(v);
}
});
$(_aae).combobox("setValues",vv);
}
}
opts.blurTimer=null;
}
...
}}),panelEvents:{mouseover:_a8c,mouseout:_a8d,click:_a8e,scroll:_a91},filter:function(q,row){
var opts=$(this).combobox("options");
...
return data;
},finder:{getEl:function(_ab4,_ab5){
var _ab6=_a55(_ab4,_ab5);
var id=$.data(_ab4,"combobox").itemIdPrefix+"_"+_ab6;
return $("#"+id);
},getGroupEl:function(_ab7,_ab8){
var _ab9=$.data(_ab7,"combobox");
var _aba=$.easyui.indexOfArray(_ab9.groups,"value",_ab8);
var id=_ab9.groupIdPrefix+"_"+_aba;
return $("#"+id);
},getGroup:function(_abb,p){
var _abc=$.data(_abb,"combobox");
var _abd=p.attr("id").substr(_abc.groupIdPrefix.length+1);
return _abc.groups[parseInt(_abd)];
},getRow:function(_abe,p){
var _abf=$.data(_abe,"combobox");
var _ac0=(p instanceof $)?p.attr("id").substr(_abf.itemIdPrefix.length+1):_a55(_abe,p);
return _abf.data[parseInt(_ac0)];
}},onBeforeLoad:function(_ac1){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_ac2){
},onUnselect:function(_ac3){
},onClick:function(_ac4){
}});
})(jQuery);
(function($){
function _ac5(_ac6){
var _ac7=$.data(_ac6,"combotree");
var opts=_ac7.options;
var tree=_ac7.tree;
$(_ac6).addClass("combotree-f");
$(_ac6).combo($.extend({},opts,{onShowPanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShowPanel.call(this);
}}));
var _ac8=$(_ac6).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_ac8);
_ac7.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _ac9=$(_ac6).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_ac9,node.id);
});
}
_ace(_ac6,_ac9,_ac7.remainText);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
if(opts.multiple){
$(this).tree(node.checked?"uncheck":"check",node.target);
}else{
$(_ac6).combo("hidePanel");
}
_ac7.remainText=false;
_acb(_ac6);
opts.onClick.call(this,node);
},onCheck:function(node,_aca){
_ac7.remainText=false;
_acb(_ac6);
opts.onCheck.call(this,node,_aca);
}}));
};
function _acb(_acc){
var _acd=$.data(_acc,"combotree");
...
_ace(_acc,vv,_acd.remainText);
};
function _ace(_acf,_ad0,_ad1){
var _ad2=$.data(_acf,"combotree");
var opts=_ad2.options;
var tree=_ad2.tree;
var _ad3=tree.tree("options");
var _ad4=_ad3.onBeforeCheck;
var _ad5=_ad3.onCheck;
var _ad6=_ad3.onSelect;
_ad3.onBeforeCheck=_ad3.onCheck=_ad3.onSelect=function(){
};
if(!$.isArray(_ad0)){
_ad0=_ad0.split(opts.separator);
}
if(!opts.multiple){
_ad0=_ad0.length?[_ad0[0]]:[""];
}
var vv=$.map(_ad0,function(_ad7){
return String(_ad7);
});
...
ss.push(_ad9(v,opts.mappingRows)||v);
...
_ad3.onBeforeCheck=_ad4;
_ad3.onCheck=_ad5;
_ad3.onSelect=_ad6;
if(!_ad1){
var s=ss.join(opts.separator);
if($(_acf).combo("getText")!=s){
$(_acf).combo("setText",s);
}
}
$(_acf).combo("setValues",vv);
function _ad9(_ada,a){
var item=$.easyui.getArrayItem(a,"id",_ada);
return item?_ad8(item):undefined;
};
function _ad8(node){
return node[opts.textField||""]||node.text;
};
};
function _adb(_adc,q){
var _add=$.data(_adc,"combotree");
var opts=_add.options;
var tree=_add.tree;
_add.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _ade(_adf){
var _ae0=$.data(_adf,"combotree");
_ae0.remainText=false;
$(_adf).combotree("setValues",$(_adf).combotree("getValues"));
$(_adf).combotree("hidePanel");
};
$.fn.combotree=function(_ae1,_ae2){
if(typeof _ae1=="string"){
var _ae3=$.fn.combotree.methods[_ae1];
if(_ae3){
return _ae3(this,_ae2);
}else{
return this.combo(_ae1,_ae2);
}
}
_ae1=_ae1||{};
return this.each(function(){
var _ae4=$.data(this,"combotree");
if(_ae4){
$.extend(_ae4.options,_ae1);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_ae1)});
}
_ac5(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _ae5=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_ae5.width,height:_ae5.height,originalValue:_ae5.originalValue,disabled:_ae5.disabled,readonly:_ae5.readonly});
},clone:function(jq,_ae6){
var t=jq.combo("clone",_ae6);
...
},setValues:function(jq,_ae7){
return jq.each(function(){
var opts=$(this).combotree("options");
if($.isArray(_ae7)){
_ae7=$.map(_ae7,function(_ae8){
if(_ae8&&typeof _ae8=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_ae8);
return _ae8.id;
}else{
return _ae8;
}
...
},setValue:function(jq,_ae9){
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_ae9)?_ae9:[_ae9]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_aea){
return $.extend({},$.fn.combo.parseOptions(_aea),$.fn.tree.parseOptions(_aea));
};
...
var grid=_aed.grid;
$(_aec).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_b02(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _aee=p.outerHeight()-p.height();
var _aef=p._size("minHeight");
var _af0=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_aef?_aef-_aee:""),maxHeight:(_af0?_af0-_aee:"")});
...
var _af1=$(_aec).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_af1);
_aed.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_af2,onClickRow:_af3,onSelect:_af4("onSelect"),onUnselect:_af4("onUnselect"),onSelectAll:_af4("onSelectAll"),onUnselectAll:_af4("onUnselectAll")}));
function _af5(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_aec;
};
function _af2(data){
var _af6=_af5(this);
var _af7=$(_af6).data("combogrid");
var opts=_af7.options;
var _af8=$(_af6).combo("getValues");
_b02(_af6,_af8,_af7.remainText);
opts.onLoadSuccess.call(this,data);
};
function _af3(_af9,row){
var _afa=_af5(this);
var _afb=$(_afa).data("combogrid");
...
opts.onClickRow.call(this,_af9,row);
};
function _af4(_afd){
return function(_afe,row){
var _aff=_af5(this);
var opts=$(_aff).combogrid("options");
if(_afd=="onUnselectAll"){
if(opts.multiple){
_afc.call(this);
}
}else{
...
opts[_afd].call(this,_afe,row);
};
};
function _afc(){
var dg=$(this);
var _b00=_af5(dg);
var _b01=$(_b00).data("combogrid");
var opts=_b01.options;
var vv=$.map(dg.datagrid("getSelections"),function(row){
return row[opts.idField];
});
vv=vv.concat(opts.unselectedValues);
_b02(_b00,vv,_b01.remainText);
};
};
function nav(_b03,dir){
var _b04=$.data(_b03,"combogrid");
var opts=_b04.options;
var grid=_b04.grid;
var _b05=grid.datagrid("getRows").length;
if(!_b05){
return;
}
...
var _b06;
if(!tr.length){
_b06=(dir=="next"?0:_b05-1);
}else{
var _b06=parseInt(tr.attr("datagrid-row-index"));
_b06+=(dir=="next"?1:-1);
if(_b06<0){
_b06=_b05-1;
}
...
grid.datagrid("highlightRow",_b06);
if(opts.selectOnNavigation){
_b04.remainText=false;
grid.datagrid("selectRow",_b06);
}
};
function _b02(_b07,_b08,_b09){
var _b0a=$.data(_b07,"combogrid");
var opts=_b0a.options;
var grid=_b0a.grid;
var _b0b=$(_b07).combo("getValues");
var _b0c=$(_b07).combo("options");
var _b0d=_b0c.onChange;
_b0c.onChange=function(){
};
var _b0e=grid.datagrid("options");
var _b0f=_b0e.onSelect;
var _b10=_b0e.onUnselectAll;
_b0e.onSelect=_b0e.onUnselectAll=function(){
};
if(!$.isArray(_b08)){
...
var vv=$.map(_b08,function(_b11){
return String(_b11);
});
vv=$.grep(vv,function(v,_b12){
return _b12===$.inArray(v,vv);
});
var _b13=$.grep(grid.datagrid("getSelections"),function(row,_b14){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_b13;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _b15=grid.datagrid("getRowIndex",v);
if(_b15>=0){
grid.datagrid("selectRow",_b15);
}else{
opts.unselectedValues.push(v);
}
ss.push(_b16(v,grid.datagrid("getRows"))||_b16(v,_b13)||_b16(v,opts.mappingRows)||v);
});
$(_b07).combo("setValues",_b0b);
_b0c.onChange=_b0d;
_b0e.onSelect=_b0f;
_b0e.onUnselectAll=_b10;
if(!_b09){
var s=ss.join(opts.separator);
...
$(_b07).combo("setValues",_b08);
function _b16(_b17,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b17);
return item?item[opts.textField]:undefined;
};
};
function _b18(_b19,q){
var _b1a=$.data(_b19,"combogrid");
var opts=_b1a.options;
var grid=_b1a.grid;
_b1a.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
...
q=$.trim(q);
var _b1c=q;
_b1d(opts.mappingRows,q);
_b1d(grid.datagrid("getSelections"),q);
var _b1e=_b1d(rows,q);
if(_b1e>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_b1e);
}
}else{
$.map(rows,function(row,i){
if(opts.filter.call(_b19,q,row)){
...
function _b1f(_b20){
var _b21=$.data(_b20,"combogrid");
var opts=_b21.options;
var grid=_b21.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_b21.remainText=false;
if(tr.length){
var _b22=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_b22);
}else{
grid.datagrid("selectRow",_b22);
}
}else{
grid.datagrid("selectRow",_b22);
}
...
$(_b20).combogrid("setValues",vv);
if(!opts.multiple){
$(_b20).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_b23,_b24){
if(typeof _b23=="string"){
var _b25=$.fn.combogrid.methods[_b23];
if(_b25){
return _b25(this,_b24);
}else{
return this.combo(_b23,_b24);
}
}
_b23=_b23||{};
return this.each(function(){
var _b26=$.data(this,"combogrid");
if(_b26){
$.extend(_b26.options,_b23);
}else{
_b26=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_b23)});
}
_aeb(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _b27=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_b27.width,height:_b27.height,originalValue:_b27.originalValue,disabled:_b27.disabled,readonly:_b27.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
if($.isArray(_b28)){
_b28=$.map(_b28,function(_b29){
if(_b29&&typeof _b29=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b29);
return _b29[opts.idField];
}else{
return _b29;
}
});
...
},setValue:function(jq,_b2a){
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_b2a)?_b2a:[_b2a]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_b2b){
var t=$(_b2b);
return $.extend({},$.fn.combo.parseOptions(_b2b),$.fn.datagrid.parseOptions(_b2b),$.parser.parseOptions(_b2b,["idField","textField","mode"]));
};
...
var _b2c=e.data.target;
var opts=$(_b2c).combogrid("options");
if(opts.reversed){
$(_b2c).combogrid("setValues",$(_b2c).combogrid("getValues"));
}
...
$(_b2e).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _b30=p.outerHeight()-p.height();
var _b31=p._size("minHeight");
var _b32=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_b31?_b31-_b30:""),maxHeight:(_b32?_b32-_b30:"")});
...
if(!_b2f.grid){
var _b33=$(_b2e).combo("panel");
_b2f.grid=$("<table></table>").appendTo(_b33);
}
_b2f.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _b34=$(_b2e).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_b34,row[opts.idField]);
});
}
_b39(_b2e,_b34);
...
$(_b2e).combo("hidePanel");
}
_b36(_b2e);
opts.onClickRow.call(this,row);
},onCheckNode:function(row,_b35){
_b36(_b2e);
opts.onCheckNode.call(this,row,_b35);
}}));
};
function _b36(_b37){
...
function _b39(_b3a,_b3b){
var _b3c=$.data(_b3a,"combotreegrid");
...
var vv=$.map(_b3b,function(_b3d){
return String(_b3d);
});
vv=$.grep(vv,function(v,_b3e){
return _b3e===$.inArray(v,vv);
});
var _b3f=grid.treegrid("getSelected");
if(_b3f){
grid.treegrid("unselect",_b3f[opts.idField]);
}
...
ss.push(_b41(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
if(!_b3c.remainText){
var s=ss.join(opts.separator);
if($(_b3a).combo("getText")!=s){
$(_b3a).combo("setText",s);
}
}
$(_b3a).combo("setValues",vv);
function _b41(_b42,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b42);
return item?_b40(item):undefined;
};
function _b40(row){
return row[opts.textField||""]||row[opts.treeField];
};
};
function _b43(_b44,q){
var _b45=$.data(_b44,"combotreegrid");
var opts=_b45.options;
var grid=_b45.grid;
_b45.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
qq=$.grep(qq,function(q){
return $.trim(q)!="";
});
...
if(opts.filter.call(_b44,q,row)){
...
_b46(vv);
_b45.remainText=false;
}
}
function _b46(vv){
if(!opts.reversed){
$(_b44).combotreegrid("setValues",vv);
}
};
};
function _b47(_b48){
var _b49=$.data(_b48,"combotreegrid");
var opts=_b49.options;
var grid=_b49.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_b49.remainText=false;
if(tr.length){
...
$(_b48).combotreegrid("setValues",vv);
if(!opts.multiple){
$(_b48).combotreegrid("hidePanel");
}
};
$.fn.combotreegrid=function(_b4a,_b4b){
if(typeof _b4a=="string"){
var _b4c=$.fn.combotreegrid.methods[_b4a];
if(_b4c){
return _b4c(this,_b4b);
}else{
return this.combo(_b4a,_b4b);
}
}
_b4a=_b4a||{};
return this.each(function(){
var _b4d=$.data(this,"combotreegrid");
if(_b4d){
$.extend(_b4d.options,_b4a);
}else{
_b4d=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_b4a)});
}
_b2d(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _b4e=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_b4e.width,height:_b4e.height,originalValue:_b4e.originalValue,disabled:_b4e.disabled,readonly:_b4e.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_b4f){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_b4f)){
_b4f=$.map(_b4f,function(_b50){
if(_b50&&typeof _b50=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b50);
return _b50[opts.idField];
}else{
return _b50;
}
});
...
},setValue:function(jq,_b51){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_b51)?_b51:[_b51]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_b52){
var t=$(_b52);
return $.extend({},$.fn.combo.parseOptions(_b52),$.fn.treegrid.parseOptions(_b52),$.parser.parseOptions(_b52,["mode",{limitToGrid:"boolean"}]));
};
...
var _b53=e.data.target;
var opts=$(_b53).combotreegrid("options");
if(opts.limitToGrid){
_b47(_b53);
}
}}),filter:function(q,row){
...
(function($){
function _b54(_b55){
var _b56=$.data(_b55,"tagbox");
var opts=_b56.options;
$(_b55).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_b57,_b58){
_b59();
$(this).combobox("hidePanel");
opts.onChange.call(_b55,_b57,_b58);
},onResizing:function(_b5a,_b5b){
var _b5c=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
tb.css({height:"",paddingLeft:_b5c.css("marginLeft"),paddingRight:_b5c.css("marginRight")});
_b5c.css("margin",0);
tb._size({width:opts.width},$(this).parent());
_b6f(_b55);
_b61(this);
opts.onResizing.call(_b55,_b5a,_b5b);
},onLoadSuccess:function(data){
_b59();
opts.onLoadSuccess.call(_b55,data);
}}));
_b59();
_b6f(_b55);
function _b59(){
$(_b55).next().find(".tagbox-label").remove();
var _b5d=$(_b55).tagbox("textbox");
var ss=[];
$.map($(_b55).tagbox("getValues"),function(_b5e,_b5f){
var row=opts.finder.getRow(_b55,_b5e);
var text=opts.tagFormatter.call(_b55,_b5e,row);
var cs={};
var css=opts.tagStyler.call(_b55,_b5e,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _b60=$("<span class=\"tagbox-label\"></span>").insertBefore(_b5d).html(text);
_b60.attr("tagbox-index",_b5f);
_b60.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_b60);
});
_b61(_b55);
$(_b55).combobox("setText","");
};
};
function _b61(_b62,_b63){
var span=$(_b62).next();
var _b64=_b63?$(_b63):span.find(".tagbox-label");
if(_b64.length){
var _b65=$(_b62).tagbox("textbox");
var _b66=$(_b64[0]);
var _b67=_b66.outerHeight(true)-_b66.outerHeight();
var _b68=_b65.outerHeight()-_b67*2;
_b64.css({height:_b68+"px",lineHeight:_b68+"px"});
var _b69=span.find(".textbox-addon").css("height","100%");
_b69.find(".textbox-icon").css("height","100%");
...
var opts=$(_b6b).tagbox("options");
if(opts.disabled||opts.readonly){
return;
}
if($(e.target).hasClass("tagbox-remove")){
var _b6c=parseInt($(e.target).parent().attr("tagbox-index"));
var _b6d=$(_b6b).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_b6b,_b6d[_b6c])==false){
return;
}
opts.onRemoveTag.call(_b6b,_b6d[_b6c]);
_b6d.splice(_b6c,1);
$(_b6b).tagbox("setValues",_b6d);
}else{
var _b6e=$(e.target).closest(".tagbox-label");
if(_b6e.length){
var _b6c=parseInt(_b6e.attr("tagbox-index"));
var _b6d=$(_b6b).tagbox("getValues");
opts.onClickTag.call(_b6b,_b6d[_b6c]);
}
}
...
var _b71=$(_b70).tagbox("textbox");
var span=$(_b70).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_b71.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_b71.css("fontFamily"),fontSize:_b71.css("fontSize"),fontWeight:_b71.css("fontWeight"),whiteSpace:"nowrap"});
var _b72=_b73(_b71.val());
var _b74=_b73(opts.prompt||"");
tmp.remove();
var _b75=Math.min(Math.max(_b72,_b74)+20,span.width());
_b71._outerWidth(_b75);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _b73(val){
...
if(opts.limitToList){
var _b78=t.tagbox("panel");
var item=_b78.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b77,item);
var _b79=row[opts.valueField];
$(_b77).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_b79);
}
$(_b77).tagbox("hidePanel");
}else{
var v=$.trim($(_b77).tagbox("getText"));
if(v!==""){
var _b7a=$(_b77).tagbox("getValues");
_b7a.push(v);
$(_b77).tagbox("setValues",_b7a);
}
}
};
function _b7b(_b7c,_b7d){
$(_b7c).combobox("setText","");
_b6f(_b7c);
$(_b7c).combobox("setValues",_b7d);
$(_b7c).combobox("setText","");
$(_b7c).tagbox("validate");
};
$.fn.tagbox=function(_b7e,_b7f){
if(typeof _b7e=="string"){
var _b80=$.fn.tagbox.methods[_b7e];
if(_b80){
return _b80(this,_b7f);
}else{
return this.combobox(_b7e,_b7f);
}
}
_b7e=_b7e||{};
return this.each(function(){
var _b81=$.data(this,"tagbox");
if(_b81){
$.extend(_b81.options,_b7e);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_b7e)});
}
_b54(this);
_b6a(this);
});
...
var _b82=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_b82.width,height:_b82.height,originalValue:_b82.originalValue,disabled:_b82.disabled,readonly:_b82.readonly});
},setValues:function(jq,_b83){
return jq.each(function(){
_b7b(this,_b83);
});
},reset:function(jq){
...
$.fn.tagbox.parseOptions=function(_b84){
return $.extend({},$.fn.combobox.parseOptions(_b84),$.parser.parseOptions(_b84,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_b85){
var vv=$(_b85).parent().prev().tagbox("getValues");
if($(_b85).is(":focus")){
vv.push($(_b85).val());
}
return vv.join(",");
...
}}),tagFormatter:function(_b87,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_b87;
},tagStyler:function(_b88,row){
return "";
},onClickTag:function(_b89){
},onBeforeRemoveTag:function(_b8a){
},onRemoveTag:function(_b8b){
}});
})(jQuery);
(function($){
function _b8c(_b8d){
var _b8e=$.data(_b8d,"datebox");
var opts=_b8e.options;
$(_b8d).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_b8f(this);
_b90(this);
_b91(this);
_b9f(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_b8e.calendar){
var _b92=$(_b8d).combo("panel").css("overflow","hidden");
_b92.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_b92);
...
_b8e.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_b8e.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _b93=this.target;
var opts=$(_b93).datebox("options");
_b9f(_b93,opts.formatter.call(_b93,date));
$(_b93).combo("hidePanel");
opts.onSelect.call(_b93,date);
}});
}
$(_b8d).combo("textbox").parent().addClass("datebox");
$(_b8d).datebox("initValue",opts.value);
function _b8f(_b94){
var opts=$(_b94).datebox("options");
var _b95=$(_b94).combo("panel");
_b95.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b96=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b96].handler.call(e.target,_b94);
}
});
};
function _b90(_b97){
var _b98=$(_b97).combo("panel");
if(_b98.children("div.datebox-button").length){
return;
}
var _b99=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b98);
var tr=_b99.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_b97):btn.text).appendTo(td);
t.attr("datebox-button-index",i);
}
tr.find("td").css("width",(100/opts.buttons.length)+"%");
};
function _b91(_b9a){
var _b9b=$(_b9a).combo("panel");
var cc=_b9b.children("div.datebox-calendar-inner");
_b9b.children()._outerWidth(_b9b.width());
_b8e.calendar.appendTo(cc);
_b8e.calendar[0].target=_b9a;
if(opts.panelHeight!="auto"){
var _b9c=_b9b.height();
_b9b.children().not(cc).each(function(){
_b9c-=$(this).outerHeight();
});
cc._outerHeight(_b9c);
}
_b8e.calendar.calendar("resize");
};
};
...
function _ba0(_ba1){
var _ba2=$.data(_ba1,"datebox");
var opts=_ba2.options;
var _ba3=_ba2.calendar.calendar("options").current;
if(_ba3){
_b9f(_ba1,opts.formatter.call(_ba1,_ba3));
$(_ba1).combo("hidePanel");
}
};
function _b9f(_ba4,_ba5,_ba6){
var _ba7=$.data(_ba4,"datebox");
var opts=_ba7.options;
var _ba8=_ba7.calendar;
_ba8.calendar("moveTo",opts.parser.call(_ba4,_ba5));
if(_ba6){
$(_ba4).combo("setValue",_ba5);
}else{
if(_ba5){
_ba5=opts.formatter.call(_ba4,_ba8.calendar("options").current);
}
$(_ba4).combo("setText",_ba5).combo("setValue",_ba5);
}
};
$.fn.datebox=function(_ba9,_baa){
if(typeof _ba9=="string"){
var _bab=$.fn.datebox.methods[_ba9];
if(_bab){
...
_ba9=_ba9||{};
return this.each(function(){
var _bac=$.data(this,"datebox");
if(_bac){
$.extend(_bac.options,_ba9);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_ba9)});
}
_b8c(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_bad.width,height:_bad.height,originalValue:_bad.originalValue,disabled:_bad.disabled,readonly:_bad.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_bae){
return jq.each(function(){
var opts=$(this).datebox("options");
var _baf=opts.value;
if(_baf){
_baf=opts.formatter.call(this,opts.parser.call(this,_baf));
}
$(this).combo("initValue",_baf).combo("setText",_baf);
});
},setValue:function(jq,_bb0){
return jq.each(function(){
_b9f(this,_bb0);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_bb1){
return $.extend({},$.fn.combo.parseOptions(_bb1),$.parser.parseOptions(_bb1,["sharedCalendar"]));
};
...
_b9d(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_bb2){
return $(_bb2).datebox("options").currentText;
},handler:function(_bb3){
var now=new Date();
$(_bb3).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_ba0(_bb3);
}},{text:function(_bb4){
return $(_bb4).datebox("options").closeText;
},handler:function(_bb5){
...
(function($){
function _bb6(_bb7){
var _bb8=$.data(_bb7,"datetimebox");
var opts=_bb8.options;
$(_bb7).datebox($.extend({},opts,{onShowPanel:function(){
var _bb9=$(this).datetimebox("getValue");
_bbf(this,_bb9,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_bb7).removeClass("datebox-f").addClass("datetimebox-f");
$(_bb7).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_bb8.spinner){
var _bba=$(_bb7).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_bba.children("div.datebox-calendar-inner"));
_bb8.spinner=p.children("input");
}
_bb8.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_bb7).datetimebox("initValue",opts.value);
};
function _bbb(_bbc){
var c=$(_bbc).datetimebox("calendar");
var t=$(_bbc).datetimebox("spinner");
...
function _bc0(_bc1){
var opts=$.data(_bc1,"datetimebox").options;
var date=_bbb(_bc1);
_bbf(_bc1,opts.formatter.call(_bc1,date));
$(_bc1).combo("hidePanel");
};
function _bbf(_bc2,_bc3,_bc4){
var opts=$.data(_bc2,"datetimebox").options;
$(_bc2).combo("setValue",_bc3);
if(!_bc4){
if(_bc3){
var date=opts.parser.call(_bc2,_bc3);
$(_bc2).combo("setText",opts.formatter.call(_bc2,date));
$(_bc2).combo("setValue",opts.formatter.call(_bc2,date));
}else{
$(_bc2).combo("setText",_bc3);
}
}
var date=opts.parser.call(_bc2,_bc3);
$(_bc2).datetimebox("calendar").calendar("moveTo",date);
$(_bc2).datetimebox("spinner").timespinner("setValue",_bc5(date));
function _bc5(date){
function _bc6(_bc7){
return (_bc7<10?"0":"")+_bc7;
};
var tt=[_bc6(date.getHours()),_bc6(date.getMinutes())];
if(opts.showSeconds){
tt.push(_bc6(date.getSeconds()));
}
return tt.join($(_bc2).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_bc8,_bc9){
if(typeof _bc8=="string"){
var _bca=$.fn.datetimebox.methods[_bc8];
if(_bca){
return _bca(this,_bc9);
}else{
return this.datebox(_bc8,_bc9);
}
}
_bc8=_bc8||{};
return this.each(function(){
var _bcb=$.data(this,"datetimebox");
if(_bcb){
$.extend(_bcb.options,_bc8);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_bc8)});
}
_bb6(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _bcc=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_bcc.originalValue,disabled:_bcc.disabled,readonly:_bcc.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_bcd){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _bce=opts.value;
if(_bce){
_bce=opts.formatter.call(this,opts.parser.call(this,_bce));
}
$(this).combo("initValue",_bce).combo("setText",_bce);
});
},setValue:function(jq,_bcf){
return jq.each(function(){
_bbf(this,_bcf);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_bd0){
var t=$(_bd0);
return $.extend({},$.fn.datebox.parseOptions(_bd0),$.parser.parseOptions(_bd0,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_bbd(this,q);
}},buttons:[{text:function(_bd1){
return $(_bd1).datetimebox("options").currentText;
},handler:function(_bd2){
var opts=$(_bd2).datetimebox("options");
_bbf(_bd2,opts.formatter.call(_bd2,new Date()));
$(_bd2).datetimebox("hidePanel");
}},{text:function(_bd3){
return $(_bd3).datetimebox("options").okText;
},handler:function(_bd4){
_bc0(_bd4);
}},{text:function(_bd5){
return $(_bd5).datetimebox("options").closeText;
},handler:function(_bd6){
$(_bd6).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _bd7(_bd8){
return (_bd8<10?"0":"")+_bd8;
};
var _bd9=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bd7(h)+_bd9+_bd7(M);
...
var _bda=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_bda);
var hour=parseInt(tt[0],10)||0;
var _bdb=parseInt(tt[1],10)||0;
var _bdc=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_bdb,_bdc);
}});
})(jQuery);
(function($){
function init(_bdd){
var _bde=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bdd);
var t=$(_bdd);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_bde.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_bde.bind("_resize",function(e,_bdf){
if($(this).hasClass("easyui-fluid")||_bdf){
_be0(_bdd);
}
return false;
});
...
function _be0(_be1,_be2){
var _be3=$.data(_be1,"slider");
var opts=_be3.options;
var _be4=_be3.slider;
if(_be2){
if(_be2.width){
opts.width=_be2.width;
}
if(_be2.height){
opts.height=_be2.height;
}
}
_be4._size(opts);
if(opts.mode=="h"){
_be4.css("height","");
_be4.children("div").css("height","");
}else{
_be4.css("width","");
_be4.children("div").css("width","");
_be4.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_be4._outerHeight());
}
_be5(_be1);
};
function _be6(_be7){
var _be8=$.data(_be7,"slider");
...
_bea(aa);
function _bea(aa){
var rule=_be9.find("div.slider-rule");
var _beb=_be9.find("div.slider-rulelabel");
rule.empty();
_beb.empty();
for(var i=0;i<aa.length;i++){
var _bec=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_bec);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_beb);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_bec,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_bec,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _bed(_bee){
var _bef=$.data(_bee,"slider");
var opts=_bef.options;
var _bf0=_bef.slider;
_bf0.removeClass("slider-h slider-v slider-disabled");
_bf0.addClass(opts.mode=="h"?"slider-h":"slider-v");
_bf0.addClass(opts.disabled?"slider-disabled":"");
var _bf1=_bf0.find(".slider-inner");
_bf1.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_bf1.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_bf0.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_bef.isDragging=true;
opts.onSlideStart.call(_bee,opts.value);
},onStopDrag:function(e){
_bf3(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_bee,opts.value);
opts.onComplete.call(_bee,opts.value);
_bef.isDragging=false;
}});
_bf0.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_bef.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_bf3(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_bee,opts.value);
});
function _bf3(pos,_bf4){
var _bf5=_bf6(_bee,pos);
var s=Math.abs(_bf5%opts.step);
if(s<opts.step/2){
_bf5-=s;
}else{
_bf5=_bf5-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_bf4){
var _bf7=$(_bf4).nextAll(".slider-handle").length>0;
if(_bf5<=v2&&_bf7){
v1=_bf5;
}else{
if(_bf5>=v1&&(!_bf7)){
...
_bf5<m?v1=_bf5:v2=_bf5;
}
}
}
$(_bee).slider("setValues",[v1,v2]);
}else{
$(_bee).slider("setValue",_bf5);
}
};
};
function _bf8(_bf9,_bfa){
var _bfb=$.data(_bf9,"slider");
var opts=_bfb.options;
var _bfc=_bfb.slider;
var _bfd=$.isArray(opts.value)?opts.value:[opts.value];
var _bfe=[];
if(!$.isArray(_bfa)){
_bfa=$.map(String(_bfa).split(opts.separator),function(v){
return parseFloat(v);
});
}
_bfc.find(".slider-value").remove();
var name=$(_bf9).attr("sliderName")||"";
...
var _c00=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_bfc);
_c00.attr("name",name);
_c00.val(_bff);
_bfe.push(_bff);
var _c01=_bfc.find(".slider-handle:eq("+i+")");
var tip=_c01.next();
var pos=_c02(_bf9,_bff);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bf9,_bff));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _c03="left:"+pos+"px;";
_c01.attr("style",_c03);
tip.attr("style",_c03+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _c03="top:"+pos+"px;";
_c01.attr("style",_c03);
tip.attr("style",_c03+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_bfe:_bfe[0];
$(_bf9).val(opts.range?_bfe.join(opts.separator):_bfe[0]);
if(_bfd.join(",")!=_bfe.join(",")){
opts.onChange.call(_bf9,opts.value,(opts.range?_bfd:_bfd[0]));
}
};
function _be5(_c04){
var opts=$.data(_c04,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bf8(_c04,opts.value);
opts.onChange=fn;
};
function _c02(_c05,_c06){
var _c07=$.data(_c05,"slider");
var opts=_c07.options;
var _c08=_c07.slider;
var size=opts.mode=="h"?_c08.width():_c08.height();
var pos=opts.converter.toPosition.call(_c05,_c06,size);
if(opts.mode=="v"){
pos=_c08.height()-pos;
}
if(opts.reversed){
...
function _bf6(_c09,pos){
var _c0a=$.data(_c09,"slider");
var opts=_c0a.options;
var _c0b=_c0a.slider;
var size=opts.mode=="h"?_c0b.width():_c0b.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _c0c=opts.converter.toValue.call(_c09,pos,size);
return _c0c.toFixed(0);
};
$.fn.slider=function(_c0d,_c0e){
if(typeof _c0d=="string"){
return $.fn.slider.methods[_c0d](this,_c0e);
}
_c0d=_c0d||{};
return this.each(function(){
var _c0f=$.data(this,"slider");
if(_c0f){
$.extend(_c0f.options,_c0d);
}else{
_c0f=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_c0d),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bf8(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_c13){
var t=$(_c13);
return $.extend({},$.parser.parseOptions(_c13,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_c14){
return _c14;
},converter:{toPosition:function(_c15,size){
var opts=$(this).slider("options");
return (_c15-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_c16,_c17){
},onSlideStart:function(_c18){
},onSlideEnd:function(_c19){
},onComplete:function(_c1a){
}};
})(jQuery);
